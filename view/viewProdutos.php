...
include_once "../model/extendsProdutos.php";
include_once '../controller/DAOProdutos.php';

$produtoDAO = new DAOProdutos();
$product = new produtosa();
...
if (isset($_POST['cadastrar'])) 
{
    ...
    $produtoDAO->InsertProduto($product);
            ...
            <form method="post" action="">
                <div class="container d-flex justify-content-around flex-column">
                    ...
                    <div class="mb-3 p-2">
                        ...
                        <input type="text" name="preco" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="container d-flex justify-content-around flex-row">
                    <div class="mb-3 p-2">
                        <label for="exampleInputEmail1" class="form-label">Quantidade:</label>
                        <input type="text" name="quantidade" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>                    
                </div>
                <div class="mb-3 p-2">
                        <div class="container d-flex justify-content-around flex-row">
